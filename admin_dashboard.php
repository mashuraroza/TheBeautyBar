...
<div class="container">
    ...
    <section id="medicine_inventory">
        <h3 class="section-title">Cosmetics Inventory</h3>
        <div class="table-responsive">
    ...
    <section id="add_medicine">
        <h3 class="section-title">Add New Makeup Products</h3>
        <form action="admin_dashboard.php" method="POST" class="p-3 border rounded bg-white">
            ...
            <button type="submit" name="add_medicine" class="btn btn-primary">Add Cosmetics</button>
        </form>
    </section>
</div>
