    ...
    <script>
        ...
        function addMedicineField() {
            if (medicineCount < 10) {
                ...
                medicineNameLabel.innerText = `Product Name ${medicineCount}:`;
                ...
                medicineNameInput.placeholder = 'Enter product name';
            ...
            <div class="card delivery-card">
                ...
                <div class="card-body p-4 bg-white">
                    <form action="process_home_delivery.php" method="POST">
                        ...
                        <h5 class="form-label mt-4">Products</h5>
                        <div id="medicineContainer">
                            <!-- Initial medicine field -->
                            <div class="mb-3 medicine-field">
                                <label class="form-label">Product Name 1:</label>
                        ...
                        <button type="button" class="btn btn-outline-primary mb-3" onclick="addMedicineField()">Add Another Product</button>
